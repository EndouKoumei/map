...
# ── Cấu hình nguồn dữ liệu NOAA (kế thừa GR2) ───────────────────────────────
...
# ── Cấu hình vùng lọc (vùng biển ảnh hưởng đến Việt Nam) ─────────────────────
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='data/storms_vn.geojson',
